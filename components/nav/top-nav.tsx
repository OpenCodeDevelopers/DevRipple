      ...
      {user ? (
        <Popover>
          <PopoverTrigger asChild>
            <button className="relative flex items-center justify-center h-9 w-9 rounded-full focus:outline-none focus-visible:ring-2 focus-visible:ring-primary">
        ...
        <Button
          size="sm"
          onClick={signIn}
          className="group transition-transform hover:scale-[1.05]"
        >
